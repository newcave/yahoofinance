...
# ── KPX API 키 (Decoding) ────────────────────────────────────────
KPX_API_KEY = "24g7V5xi4Wvb9S3eAk6u1+FjKNl6i0/CHSrkKKAZoHJZ/vw7tNfXpSmiq0bXBcnK18B0jdDRxHntUOlOek+2DQ=="
...
with st.expander("🔧 SMP API 응답 확인 (디버그)"):
    try:
        ...
        resp = requests.get(
            ...
            params={"serviceKey": KPX_API_KEY, "numOfRows": 5,
                    "pageNo": 1, "returnType": "json", "reqDate": test_date},
            timeout=8,
        )
